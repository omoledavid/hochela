...
class SupportTicketController extends Controller
{
    public function tickets()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->with('user', 'owner')->paginate(getPaginate());
    ...
    public function ticketReply($id)
    {
        ...
        $messages = SupportMessage::with('ticket')->with('supportAttachments')->where('supportticket_id', $ticket->id)->orderBy('id','desc')->get();
