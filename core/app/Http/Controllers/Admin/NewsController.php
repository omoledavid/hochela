...
class NewsController extends Controller
{
    ...
    public function filterByCategory($categoryId, $categoryName)
    {
        ...
        $admin = Auth::guard('admin')->user();
        $news = News::where('category_id', $categoryId)->where('user_id', $admin->id)->active()->with('category', 'user')->latest()->paginate(getPaginate());
        $categories = Category::active()->orderBy('name')->get();
    ...
    {
        $pageTitle = "User Pending Blog Post";
    ...
    {
        $pageTitle = "User Approved Blog Post";
    ...
    {
        $pageTitle = "User Rejected Blog Post";
