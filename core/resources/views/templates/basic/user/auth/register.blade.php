                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" value="{{ old('firstname') }}"
                                       placeholder="@lang('Enter firstname')" class="form--control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="lastname" value="{{ old('lastname') }}"
                                       placeholder="@lang('Enter lastname')" class="form--control" required>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input id="username" type="text" class="form--control checkUser" name="username"
                                       placeholder="@lang('Enter your username')" value="{{ old('username') }}"
                                       required>
                        ...
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="form--control checkUser"
                                       placeholder="@lang('Enter your email address')" name="email"
                        ...
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            <div class="form-group">
                                ...
                                <input id="password-confirm" type="password" class="form--control"
                                       ...
                                       placeholder="@lang('Enter your confirmation password')" required
                        ...
                        <div class="form-group mt-4">
                            ...
                            <a href="{{ route('google.login')}}"
                               class="btn w-100 mt-3 google-btn">@lang('Register with Google') <i
