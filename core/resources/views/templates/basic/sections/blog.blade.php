    ...
    <div class="container">
        ...
        <div class="row gy-4">
            @foreach ($blogs as $blog)
                    ...
                    <div class="blog-post">
                        <a href="{{ route('blog.details', [$blog->id, slug($blog->title)]) }}" class="t-link blog-post__img">
                        <img
                        ...
                        <h4 class="text-capitalize mb-3 mt-0">
                            <a href="{{ route('blog.details', [$blog->id, slug($blog->title)]) }}" class="t-link blog-post__title">
                            {{ __($blog->title) }}
                            </a>
                        </h4>
                        <ul class="list list--row">
                            ...
                            <p class="blog-post__article mt-3 mb-0">
                                @php
                                    echo shortDescription(strip_tags($blog->description_nic));
                                @endphp
                            </p>
                        </div>
                    </div>
