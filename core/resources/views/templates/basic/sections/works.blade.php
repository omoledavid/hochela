...
<section class="pt-100 pb-100 bg-img how-work-section"
         style="background-image: url('{{ getImage('assets/images/frontend/works/'.$work->data_values->background_image, '1920x1090') }}')">
    <div class="left-el">
        <img src="{{ getImage('assets/images/frontend/works/'.$work->data_values->left_image, '575x755') }}"
             alt="image">
    </div>
    <div class="right-el">
        <img src="{{ getImage('assets/images/frontend/works/'.$work->data_values->right_image, '665x785') }}"
             alt="image">
    </div>
    <div class="container">
