...
<section class="pt-100 pb-100 bg-img best-trip-section"
         style="background-image: url('{{ getImage('assets/images/frontend/top_trip/'.$trip->data_values->background_image, '1920x1090') }}');">
