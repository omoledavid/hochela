      ...
      <nav class="navbar navbar-expand-xl p-0 align-items-center">
        ...
        <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
          <ul class="navbar-nav main-menu ms-auto">
            ...
            <li><a href="{{ route('property.search') }}">@lang('Accommodation')</a></li>
            <li><a href="{{ route('agents') }}">@lang('Agents')</a></li>
          ...
          <div class="nav-right d-flex flex-wrap" style="gap:10px">
            ...
            <div class="d-flex flex-wrap" style="gap:10px">
              ...
              <a href="{{ route('owner.login') }}" class="btn btn-sm btn--base">@lang('Agent Login')</a>
            </div>
            @endif
