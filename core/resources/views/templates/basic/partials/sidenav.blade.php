        ...
        <div class="user-menu-widget">
            <ul class="user-menu">
                ...
                <li class="{{ menuActive('user.property.history') }}">
                    <a href="{{ route('user.property.history') }}"><i class="las la-history"></i>
                        <span>@lang('Activities')</span></a>
                </li>
                <li class="{{ menuActive('wishlist') }}">
                    <a href="{{ route('wishlist') }}"><i class="las la-heart"></i>
                        <span>@lang('Wishlist')</span></a>
                </li>
                @if($general->pr == 1)
                    <li class="{{ menuActive(['user.review', 'user.review.pending', 'user.review.complete']) }}">
                        <a href="{{ route('user.review') }}"><i class="lar la-star"></i>
                            <span>@lang('Reviews')</span></a>
                    </li>
                @endif
                ...
                <li class="{{ menuActive('user.profile.setting') }}">
                    <a href="{{ route('user.profile.setting') }}"><i class="las la-user"></i>
                        <span>@lang('Profile Setting')</span></a>
                </li>
                <li class="{{ menuActive('user.change.password') }}">
                    <a href="{{ route('user.change.password') }}"><i class="las la-user"></i>
