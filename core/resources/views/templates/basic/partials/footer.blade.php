...
<footer class="footer bg_img"
        style="background-image: url('{{ getImage('assets/images/frontend/footer/'.$footer->data_values->background_image, '1920x840') }}');">
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-lg-2 col-sm-6 order-lg-2 order-3">
                <div class="footer-widget">
                    <h4 class="footer-widget__title"><span>@lang('Hochela')</span></h4>
            ...
            <div class="col-lg-2 col-sm-6 order-lg-3 order-4">
                <div class="footer-widget">
                    <h4 class="footer-widget__title"><span>@lang('Support')</span></h4>
                    <ul class="footer-menu-list">
