...
@php
    ...
    $agents = \App\Models\Owner::where('status', 1)->get();
@endphp
          ...
          <div class="row">
            <div class="col-lg-3 pe-5">
              ...
              <div class="action-sidebar">
                ...
                <div class="action-widget">
                  <h4 class="action-widget__title">@lang('Accommodation Standard')</h4>
                  <div class="action-widget__body">
                ...
                @forelse ($properties as $property)
                  ...
                  <div class="hotel-card">
                    ...
                    <div class="hotel-card__content">
                      ...
                      <h3 class="title"><a href="{{ route('property', [$property->id, slug($property->name)]) }}">{{ __($property->name) }} </a></h3><a href=""><span><i class="lar la-heart"></i></span></a>
                      </div>
                      ...
                      <div class="course-mentor mt-2">
                        <div class="left">
                          <div class="teacher">
                            <div class="thumb"><img src="{{getImage('assets/images/user/profile/'.\App\Models\Owner::find($property->owner_id)->image,'350x350')}}" alt="image"></div>
                            <p class="name">{{__(\App\Models\Owner::find($property->owner_id)->firstname)}}</p>
                          </div>
                        </div>
                        <div class="right">
                          <span class="fs--14px">{{__(\App\Models\Property::where('owner_id', \App\Models\Owner::find($property->owner_id)->id)->count())}} @lang('Properties')</span>
                        </div>
                      </div>
                    </div>
