            ...
            <div class="row gy-3 align-items-end">
              ...
              <div class="col-xl-2 col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="date" placeholder="50,000" class=" form--control" autocomplete="off">
                </div>
              </div>
              <div class="col-xl-2 col-md-6">
                ...
                <div class="input-group">
                  <span class="input-group-text"><i class="las la-money-bill-wave"></i></span>
                  <input type="text" name="date" placeholder="250,000" class=" form--control"  autocomplete="off">
                </div>
              </div>
