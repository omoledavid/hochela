                                        ...
                                        <tr class="category-item {{ 'category-'.$category->id }}">
                                            ...
                                            <td data-label="@lang('Select')">
                                                <div class="switch-button">
                                                    <input type="checkbox" name="isSelectCheckbox[]" id="switch-label-{{ $room->id }}" class="switch-button__checkbox isSelect" data-id="{{ $room->id }}" data-room_number="{{ $room->room_number }}" data-adult="{{ $room->adult }}" data-child="{{ $room->child }}" data-price="{{ showAmount($room->price) }}">
                        ...
                        <form action="#" class="row g-3">
                            <div class="col-12">
                                <select class="form-select form--select roomCategories">
                                    @foreach ($roomCategories as $category)
                                    <option value="{{ $category->id }}" {{ $request->categoryId == $category->id ? 'selected':'' }} data-category="{{ $category }}">{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12">
                        ...
                        <form action="{{ route('property.category.rooms.date', [$property->id, slug($property->name)]) }}" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" data-range="true" name="date" data-multiple-dates-separator=" - " data-language="en" class="datepicker-here form--control" id="date" placeholder="Checkin & Checkout" autocomplete="off" value="{{ ($searchData && $searchData['date'] != null) ? $searchData['date'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
