                    ...
                    <ul class="nav nav-tabs cumtom--nav-tabs mt-5" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="comment-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">@lang('Properties')</button>
                        </li>
                        @if($general->ar == 1)
                            <li class="nav-item" role="presentation">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="annoucement-tab" data-bs-toggle="tab"
                                        data-bs-target="#annoucement" type="button" role="tab"
                                        aria-controls="annoucement" aria-selected="false">@lang('Give Review')</button>
                            </li>
                        @endif
                    </ul>
                                            ...
                                            <div class="best-trip-card">
                                                ...
                                                <div class="content">
                                                    <div class="top">
                                                        ...
                                                        <span class="fs--14px mt-2"><i
                                                                class="las la-map-marked-alt fs--18px"></i> @lang('in') {{ __($property->location->name) }}</span>
                                                    </div>
                                                    <div class="bottom d-flex align-items-center">
                                                        ...
                                                        <div class="col-6 text-end">
                                                            <a href="{{ route('property', [$property->id, slug($property->name)]) }}"
                                                               class="btn btn-sm btn--base">@lang('View Details')</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @forelse ($agents->reviews as $review)
                                        <div class="single-rating">
                                            <div class="single-rating__thumb">
                                                <img
                                                    src="{{getImage('assets/images/user/profile/'.$review->user->image,'350x350')}}"
                                                    alt="image">
                                            </div>
                                ...
                                @auth
                                    <form class="review-form rating mt-4" method="POST" action="{{route('review')}}">
                                        ...
                                        <div class="form-group d-flex flex-wrap">
                                            <label
                                                class="review-label text-dark fw-medium mb-0 me-3">@lang('Your Ratings')
                                                :</label>
                                        ...
                                        <div class="form-group">
                                            <textarea name="review" class="form--control" id="review-comments" required
                                                      placeholder="@lang('Say Something about this agent')"></textarea>
                                        </div>
