            ...
            <div class="row gy-5">
                <div class="col-lg-8">
                    <div class="blog-post">
                        ...
                        <div class="fb-comments" data-href="{{ route('blog.details',[$blog->id,slug($blog->title)]) }}" data-numposts="5"></div>
                    </div>
                </div>
                <div class="col-lg-4">
												...
												<div class="d-flex pb-3">
													<div class="me-3 flex-shrink-0">
														<div class="user__img user__img--md">
															<img src="{{ getImage('assets/images/frontend/blog/thumb_'.$blog->image, '430x275') }}"
															...
															<li class="list--row__item">
																<div class="blog-post__meta">
																	...
																	<div class="blog-post__meta-text text-uppercase">
																		...
																		<a href="{{ route('blog.details', [$blog->id, slug($blog->title)]) }}" class="blog-post__link">{{ showDateTime($blog->created_at) }}</a>
																	</div>
																</div>
															</li>
														</ul>
