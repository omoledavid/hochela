    ...
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--primary b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <a href="{{ route('bloggers.withdraw') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('Withdraw Money')</a>
            </div>
        </div>
    ...
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <a href="{{route('bloggers.property.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--teal b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <a href="{{route('bloggers.property.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View Properties')</a>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        <div class="dashboard-w1 bg--green b-radius--10 box-shadow">
            ...
            <div class="details">
                ...
                <a href="{{route('bloggers.property.room.category.index')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View Room Categoires')</a>
            </div>
        </div>
    </div>
    @if(@$section->element)
