                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('bloggers.property.room.category.edit', $roomCategory->id) }}" class="icon-btn ml-1"><i class="la la-pen"></i></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
...
<a href="{{ route('bloggers.property.room.category.create') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
@endpush