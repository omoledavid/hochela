                    ...
                    <div class="card">
                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionExample">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('bloggers.ticket.reply', $my_ticket->id) }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row border border-radius-3 my-3 py-3 mx-2">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <a href="{{route('bloggers.ticket.download',encrypt($image->id))}}" class="mr-3"><i class="fa fa-file"></i> @lang('Attachment') {{++$k}} </a>
                                            @endforeach
                                        </div>
                                        @endif
                                    </div>
...
<div class="modal fade" id="DelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{ route('bloggers.ticket.reply', $my_ticket->id) }}">
                @csrf
