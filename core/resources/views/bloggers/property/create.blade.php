...
@section('panel')
<form action="{{ route('bloggers.property.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" name="discount" class="form-control" value="0" min="0" step="any">
...
<a href="{{ route('bloggers.property.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small">
