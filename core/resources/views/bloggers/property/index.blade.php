                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Categories')">
                                    <a href="{{ route('bloggers.property.room.category.property', [slug($property->name), $property->id]) }}" class="icon-btn btn--info ml-1">
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('bloggers.property.edit', $property->id) }}" class="icon-btn ml-1"><i class="la la-pen"></i></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
...
<a href="{{ route('bloggers.property.create') }}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
@endpush