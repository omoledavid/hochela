...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{ asset('assets/laramin/images/1.jpg') }}">
        <div class="form-wrapper">
            ...
            <form action="{{ route('bloggers.register') }}" method="POST" class="cmn-form mt-30">
                @csrf
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="text-center">
                <span class="text-dark">@lang('Already have an account?')</span> <a href="{{ route('bloggers.login') }}">@lang('Login now.')</a>
            </div>
        </div>
    </div><!-- login-area end -->
</div>
    ...
    <script>
      ...
      (function ($) {
          ...
          $('.checkUser').on('focusout',function(e){
              var url = '{{ route('bloggers.checkUser') }}';
              var value = $(this).val();
