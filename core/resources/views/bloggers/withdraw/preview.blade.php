        ...
        <div class="card card-deposit pt-3">
            <div class="card-body mt-4">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" value="{{showAmount($withdraw->bloggers->balance - ($withdraw->amount))}}" class="form-control form-control-lg" placeholder="@lang('Enter Amount')" required readonly>
                    ...
                    <div class="col-md-6">
                        <form action="{{route('bloggers.withdraw.submit')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            @endforeach
                            @endif
                            @if(auth()->guard('bloggers')->user()->ts)
                            <div class="form-group">
