...
@section('panel')
<form action="{{ route('admin.property.room.category.store') }}" method="POST">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="room_category" class="form-control" placeholder="@lang('Enter room category name')" value="{{ old('room_category') }}">
                    </div>
                    <div class="form-group">
        ...
        <div class="col-lg-12 pt-4">
            <div class="card border--dark">
                <h5 class="card-header bg--dark">@lang('Unit List')
...
<a href="{{ route('admin.property.room.category.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small">
