                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small">
                                        <a href="{{ route('admin.staffs.detail', $log->user_id) }}"><span>@</span>{{ $log->user->username }}</a>
                                    </span>
                                </td>
...
<a href="{{ route('admin.staffs.detail', $log->user_id) }}" class="btn btn--info"><i class="las la-user"></i> {{ $user->fullname }}</a>
@endpush