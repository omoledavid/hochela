            ...
            <div class="card">
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold"> @lang('Property Maxmium Star')</label>
                                <input type="number" class="form-control form-control-lg" name="property_max_star" value="{{ $general->property_max_star }}" required>
                            </div>
