...
@section('panel')      
    ...
    <div class="row mb-none-30 mt-3">
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--teal b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['total_owners']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Agents')</span>
                    </div>
                    <a href="{{route('admin.owners.all')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['verified_owners']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Verified Agents')</span>
                    </div>
                    <a href="{{route('admin.owners.active')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--danger b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['email_unverified_owners']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Email Unverified Agents')</span>
                    </div>

                    <a href="{{route('admin.owners.email.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['sms_unverified_owners']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total SMS Unverified Agents')</span>
                    </div>

                    <a href="{{route('admin.owners.sms.unverified')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Total Blog Posts')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Pending Blog Posts')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Approved Blog Posts')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span>@lang('Rejected Blog Posts')</span>
                    </div>
                    <a href="{{ route('admin.news.rejected') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-6 mb-30">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">@lang('Monthly Payment & Withdraw Report')</h5>
...
@push('script')
    ...
    <script src="{{asset('assets/laramin/js/vendor/apexcharts.min.js')}}"></script>
    <script src="{{asset('assets/laramin/js/vendor/chart.js.2.8.0.js')}}"></script>
