...
<div class="row mb-none-30">
    <div class="col-xl-3 col-lg-5 col-md-5 mb-30">
        ...
        <div class="card b-radius--10 overflow-hidden box--shadow1">
            <div class="card-body p-0">
                <div class="p-3 bg--white">
                    <h4 class="">{{$owner->fullname}}</h4>
                    <span class="text--small">@lang('Joined At') <strong>{{showDateTime($owner->created_at,'d M, Y h:i A')}}</strong></span>
                </div>
            </div>
        </div>
        ...
        <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        @lang('Balance')
                        <span class="font-weight-bold">{{showAmount($owner->balance)}} {{__($general->cur_text)}}</span>
                    </li>
                </ul>
            </div>
        </div>
        <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
            <div class="card-body">
                ...
                <a href="{{ route('admin.owners.login.history.single', $owner->id) }}" class="btn btn--primary btn--shadow btn-block btn-lg">
                    @lang('Login Logs')
                </a>
                <a href="{{route('admin.owners.email.single',$owner->id)}}" class="btn btn--info btn--shadow btn-block btn-lg">
                    @lang('Send Email')
                </a>
                <a href="{{route('admin.owners.login',$owner->id)}}" target="_blank" class="btn btn--dark btn--shadow btn-block btn-lg">
                    @lang('Login as Agents')
                </a>
                <a href="{{route('admin.owners.email.log',$owner->id)}}" class="btn btn--warning btn--shadow btn-block btn-lg">
                    @lang('Email Log')
                </a>
            </div>
        </div>
    ...
    <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
        ...
        <div class="row mb-none-30">
            <div class="col-xl-4 mb-30">
                <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                    <a href="{{route('admin.owners.withdrawals',$owner->id)}}" class="item--link"></a>
                    <div class="icon">
            ...
            <div class="col-xl-4 mb-30">
                <div class="dashboard-w1 bg--12 b-radius--10 box-shadow has--link">
                    <a href="{{route('admin.owners.transactions',$owner->id)}}" class="item--link"></a>
                    <div class="icon">
            ...
            <div class="col-xl-4 mb-30">
                <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                    <a href="{{ route('admin.owners.properties', $owner->id) }}" class="item--link"></a>
                    <div class="icon">
                        <i class="la la-exchange-alt"></i>
                    </div>
                    <div class="details">
        ...
        <div class="card mt-50">
            <div class="card-body">
                <h5 class="card-title border-bottom pb-2">@lang('Information of') {{$owner->fullname}}</h5>
                ...
                <form action="{{route('admin.owners.update',[$owner->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="mobile" value="{{$owner->mobile}}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="form-group ">
                                ...
                                <select name="country" class="form-control">
                                    ...
                                    <option value="{{ $key }}" @if($country->country == @$owner->address->country ) selected @endif>{{ __($country->country) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xl-4 col-md-6  col-sm-3 col-12">
                            ...
                            <input type="checkbox" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Active')" data-off="@lang('Banned')" data-width="100%" name="status" @if($owner->status) checked @endif>
                        </div>
