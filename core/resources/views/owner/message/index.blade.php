                    ...
                    <div class="card custom--card">
                        ...
                        <div class="card-body p-0">
                            <ul class="chat-area">
                                ...
                                @if($conversion->sender_id != auth()->guard('owner')->user()->id)
                                <li>
                                    <div class="chat-author">
                                        ...
                                        <div class="content">
                                            <h6 class="title">
                                                <a href="{{route('owner.conversation.chat',  $conversion->id)}}">{{$conversion->sender->username}}</a>
                                            </h6>
                                ...
                                <li>
                                    <div class="chat-author">
                                        ...
                                        <div class="content">
                                            <h5 class="name">
                                                <a href="{{route('owner.conversation.chat',  $conversion->id)}}">{{$conversion->receiver->username}}</a>
                                            </h5>
                                            <span class="info">{{Str::words($conversion->messages->last()->message, 8)}}</span>
                                        </div>
                                    </div>
