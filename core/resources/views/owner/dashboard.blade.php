        ...
        @if ($user->kv == 0 && $general->kr == 1)
            <div class="alert border border--info" role="alert">
                ...
                <p class="alert__message">
                    ...
                    <small><i>@lang('Please submit the required KYC information to verify yourself. Otherwise, you can\'t upload your property.')
                            <a href="{{ route('owner.kyc.form') }}"
                               class="link-color">@lang('Click here')</a> @lang('to submit KYC information')
                            .</i></small>
                </p>
            </div>
        @elseif($user->kv == 2)
            <div class="alert border border--warning" role="alert">
                ...
                <p class="alert__message">
                    ...
                    <small><i>@lang('Your submitted KYC information is pending for admin approval. Please wait till that.')
                            <a href="{{ route('owner.kyc.data') }}"
