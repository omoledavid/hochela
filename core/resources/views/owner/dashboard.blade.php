...
<div class="col-md-12">
    ...
    <div class="alert border border--warning" role="alert">
        ...
        <p class="alert__message">
            ...
            <small><i>@lang('For better identity, Please update your') <a href="{{ route('owner.profile') }}" class="link-color">@lang('Profile')</a></i>
    ...
    <div class="alert border border--info" role="alert">
        ...
        <p class="alert__message">
            ...
            <small><i>@lang('Please submit the required KYC information to verify yourself. Otherwise, you can\'t upload your property.') <a href="{{ route('owner.kyc.form') }}" class="link-color">@lang('Click here')</a> @lang('to submit KYC information').</i></small>
        </p>
    </div>
    @elseif($user->kv == 2)
    <div class="alert border border--warning" role="alert">
        ...
        <p class="alert__message">
            ...
            <small><i>@lang('Your submitted KYC information is pending for admin approval. Please wait till that.') <a href="{{ route('owner.kyc.data') }}" class="link-color">@lang('Click here')</a> @lang('to see your submitted information')</i></small>
        </p>
    </div>
    @endif
    <!-- dashboard-w1 end -->
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!$booking->status == 1)
                                    <a href="javascript:void(0)" class="icon-btn {{ $booking->status == 0 ? 'btn--warning' : ($booking->status == 1 ? 'btn--success' : 'btn--danger') }} mr-1 approveOrReject" data-original-title="{{ $booking->status == 0 ? 'Approve/Reject' : ($booking->status == 2 ? 'Reject' : 'Approve') }}" data-toggle="tooltip" data-url="{{ route('owner.conversation.check', $booking->id) }}">
                                        @if($booking->status == 0)
                                    ...
                                    @else
                                    <a class="icon-btn {{ $booking->status == 0 ? 'btn--warning' : ($booking->status == 1 ? 'btn--success' : 'btn--danger') }} mr-1 " href="javascript:void()">
                                        @if($booking->status == 0)
                                        <i class="la la-spinner"></i>
                                        @elseif($booking->status == 2)
                                        <i class="la la-times"></i>
