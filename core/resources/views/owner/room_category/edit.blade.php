...
@section('panel')
<form action="{{ route('owner.property.room.category.update', $roomCategory->id) }}" method="POST">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
...
<a href="{{ route('owner.property.room.category.index') }}" class="btn btn-sm btn--primary box--shadow1 text--small">
