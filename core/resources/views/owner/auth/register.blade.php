        ...
        <div class="form-area bg_img" data-background="{{ asset('assets/laramin/images/1.jpg') }}">
            <div class="form-wrapper">
                ...
                <form action="{{ route('owner.register') }}" method="POST" class="cmn-form mt-30">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="mobile" class="form-control checkUser" id="mobile"
                                           value="{{ old('mobile') }}" placeholder="@lang('Enter your mobile')">
                    ...
                    <div class="form-group">
                        <button style="border-radius: 10px;" type="submit" class="submit-btn mt-25">@lang('Register') <i
                                class="las la-sign-in-alt"></i></button>
                        <a href="{{ route('google.login.owner') }}" style="background: #c32828; border-radius: 10px"
                           class="submit-btn mt-25">@lang('Register with Google') <i
                                class="lab la-google-plus-g"></i>
                        </a>
                    </div>
                </form>
                <div class="text-center">
                    <span class="text-dark">@lang('Already have an account?')</span> <a
                        href="{{ route('owner.login') }}">@lang('Login now.')</a>
                </div>
            </div>
        </div><!-- login-area end -->
    </div>
