...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin', 'adminPermission')->group(function () {
        ...
        // Staffs Manager
        Route::get('staffs', 'ManageStaffsController@allUsers')->name('staffs.all');
        Route::get('staffs/active', 'ManageStaffsController@activeUsers')->name('staffs.active');
        Route::get('staffs/banned', 'ManageStaffsController@bannedUsers')->name('staffs.banned');
        Route::get('staffs/email-verified', 'ManageStaffsController@emailVerifiedUsers')->name('staffs.email.verified');
        Route::get('staffs/email-unverified', 'ManageStaffsController@emailUnverifiedUsers')->name('staffs.email.unverified');
        Route::get('staffs/sms-unverified', 'ManageStaffsController@smsUnverifiedUsers')->name('staffs.sms.unverified');
        Route::get('staffs/sms-verified', 'ManageStaffsController@smsVerifiedUsers')->name('staffs.sms.verified');
        Route::get('staffs/with-balance', 'ManageStaffsController@usersWithBalance')->name('staffs.with.balance');

        Route::get('staffs/{scope}/search', 'ManageStaffsController@search')->name('staffs.search');
        ...
        // Bloggers Manager
        Route::get('bloggers', 'ManageBloggersController@allBloggers')->name('bloggers.all');
        Route::get('bloggers/active', 'ManageBloggersController@activeBloggers')->name('bloggers.active');
        Route::get('bloggers/banned', 'ManageBloggersController@bannedBloggers')->name('bloggers.banned');
        Route::get('bloggers/email-verified', 'ManageBloggersController@emailVerifiedBloggers')->name('bloggers.email.verified');
        Route::get('bloggers/email-unverified', 'ManageBloggersController@emailUnverifiedBloggers')->name('bloggers.email.unverified');
        Route::get('bloggers/sms-unverified', 'ManageBloggersController@smsUnverifiedBloggers')->name('bloggers.sms.unverified');
        Route::get('bloggers/sms-verified', 'ManageBloggersController@smsVerifiedBloggers')->name('bloggers.sms.verified');
        Route::get('bloggers/with-balance', 'ManageBloggersController@bloggersWithBalance')->name('bloggers.with.balance');

        Route::get('bloggers/{scope}/search', 'ManageBloggersController@search')->name('bloggers.search');
        Route::get('bloggers/detail/{id}', 'ManageBloggersController@detail')->name('bloggers.detail');
        Route::post('bloggers/update/{id}', 'ManageBloggersController@update')->name('bloggers.update');
        Route::post('bloggers/add-sub-balance/{id}', 'ManageBloggersController@addSubBalance')->name('bloggers.add.sub.balance');
        Route::get('bloggers/send-email/{id}', 'ManageBloggersController@showEmailSingleForm')->name('bloggers.email.single');
        Route::post('bloggers/send-email/{id}', 'ManageBloggersController@sendEmailSingle')->name('bloggers.email.single');
        Route::get('bloggers/login/{id}', 'ManageBloggersController@login')->name('bloggers.login');
        Route::get('bloggers/transactions/{id}', 'ManageBloggersController@transactions')->name('bloggers.transactions');
        Route::get('bloggers/properties/{id}', 'ManageBloggersController@properties')->name('bloggers.properties');
        Route::get('bloggers/payments/via/{method}/{type?}/{bloggersId}', 'ManageBloggersController@depositViaMethod')->name('bloggers.deposits.method');
        Route::get('bloggers/withdrawals/{id}', 'ManageBloggersController@withdrawals')->name('bloggers.withdrawals');
        Route::get('bloggers/withdrawals/via/{method}/{type?}/{bloggersId}', 'ManageBloggersController@withdrawalsViaMethod')->name('bloggers.withdrawals.method');
        ...
        //Staff Login History
        Route::get('staffs/login/history/{id}', 'ManageStaffsController@userLoginHistory')->name('staffs.login.history.single');
        ...
        Route::get('news/approved', 'NewsController@approved')->name('news.approved');
        Route::get('news/rejected', 'NewsController@rejected')->name('news.rejected');

        Route::get('user/{id}/news', 'NewsController@userAllNews')->name('user.news.index');
        Route::get('user/{id}/news/pending', 'NewsController@userPendingNews')->name('user.news.pending');
        Route::get('user/{id}/news/approved', 'NewsController@userApprovedNews')->name('user.news.approved');
        Route::get('user/{id}/news/rejected', 'NewsController@userRejectedNews')->name('user.news.rejected');

        Route::get('news/edit/{news}/{slug?}', 'NewsController@edit')->name('news.edit');
        Route::post('news/edit/{news}/{slug?}', 'NewsController@update');
        Route::post('news/status/{news}', 'NewsController@status')->name('news.status');
        Route::post('news/delete/{news}', 'NewsController@delete')->name('news.delete');
        Route::post('news/admin-check/{news}', 'NewsController@approveOrReject')->name('news.admin.check');
        Route::get('news/filter/category/{id}/{slug}', 'NewsController@filterByCategory')->name('news.filter.search');
        Route::get('news/filter/date', 'NewsController@filterByDate')->name('news.filter.date');

        Route::get('news/create', 'NewsController@createPage')->name('news.create.page');
        Route::post('news/create', 'NewsController@create')->name('news.create');

        //Live News
        Route::get('news/live', 'NewsController@live')->name('news.live');
        Route::post('news/live', 'NewsController@storeLiveNews')->name('news.live');
...
Route::namespace('Bloggers')->prefix('bloggers')->name('bloggers.')->group(function () {
    ...
    Route::middleware('bloggers')->group(function () {
        ...
        Route::middleware('bloggers.checkStatus')->group(function () {
            ...
            Route::get('profile', 'BloggersController@profile')->name('profile');
            Route::post('profile', 'BloggersController@profileUpdate')->name('profile.update');
            Route::get('change-password', 'BloggersController@changePassword')->name('change.password');
            Route::post('change-password', 'BloggersController@submitPassword');

            //2FA
            Route::get('twofactor', 'BloggersController@show2faForm')->name('twofactor');
            Route::post('twofactor/enable', 'BloggersController@create2fa')->name('twofactor.enable');
            Route::post('twofactor/disable', 'BloggersController@disable2fa')->name('twofactor.disable');
            ...
            // Withdraw
            Route::get('/withdraw', 'BloggersController@withdrawMoney')->name('withdraw');
            Route::post('/withdraw', 'BloggersController@withdrawStore')->name('withdraw.money');
            Route::get('/withdraw/preview', 'BloggersController@withdrawPreview')->name('withdraw.preview');
            Route::post('/withdraw/preview', 'BloggersController@withdrawSubmit')->name('withdraw.submit');
            Route::get('/withdraw/history', 'BloggersController@withdrawLog')->name('withdraw.history');

            // Bloggers Support Ticket
            Route::prefix('ticket')->group(function () {
                Route::get('/', 'TicketController@supportTicket')->name('ticket');
                Route::get('/new', 'TicketController@openSupportTicket')->name('ticket.open');
                Route::post('/create', 'TicketController@storeSupportTicket')->name('ticket.store');
...
Route::get('agents', 'SiteController@agents')->name('agents');
